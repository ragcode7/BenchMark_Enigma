...
import com.benchmarkChat.chatapp.Adapter.OnItemClick;
import com.benchmarkChat.chatapp.Fragments.ChatsFragment;
import com.benchmarkChat.chatapp.Fragments.ProfileFragment;
import com.benchmarkChat.chatapp.Fragments.UsersFragment;
import com.benchmarkChat.chatapp.Model.Chat;
import com.benchmarkChat.chatapp.Model.User;
...
public class MainActivity extends AppCompatActivity implements OnItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("====dataaa"+firebaseUser);
        System.out.println("====dataaa"+firebaseUser.getUid());
        reference = FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid());
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                User user = dataSnapshot.getValue(User.class);
                System.out.println("====dataaa"+user.getId());
                System.out.println("====dataaa"+user.getUsername());
